...
my ($target,$assembly,$MAPQ,$Program_Folder_Path,$Input_File_Path,$Code_folder);#
...
$Code_folder= substr $directory, 0, -1;#substr $myscript, 0, ($L1 - $L2 - 1);#
...
#my $Input_File_Parallel="$Code_folder/lib/R/ParallelReadPerla.sh";
...
######################################################################
  ...
  system qq(R --slave --args $Program_Folder_Path,$Input_File_Path,$labeltemp,$target,$assembly,$processors,$Code_folder < $Code_folder/lib/R/DataPrepareParallel.R);
