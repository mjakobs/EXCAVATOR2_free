...
Path2ExomeRC <- file.path(CodeFolder,"lib","R","LibraryExomeRC.R")
source(Path2ExomeRC)
...
dir.create(file.path(ProgramFolder,"results/","Control"))
dir.create(file.path(ProgramFolder,"results/","Control","RCNorm"))

FileOut<-file.path(ProgramFolder,"results/","Control","RCNorm","Control.NRC.RData")
